...
//	/**
//	 * This method send request message by the client to the server
//	 * and return response message the includes mail sended
//	 *
//	 * @return MailSendedResponse the includes the mail sended
//	 */
//	public MailSendedResponse getEmailsSended() {
//		MailSendedRequest message = new MailSendedRequest();
//		return (MailSendedResponse) client.sendMessage(message);
//	}
}
